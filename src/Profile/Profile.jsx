...
import co from "../Images/new/contact.png";
import { FaBook } from "react-icons/fa";
import { IoMdPerson } from "react-icons/io";
import { FaStar } from "react-icons/fa";
import { Container, Row, Col } from "reactstrap";
import { AssignmentImg } from "../IMG-Ass/AssignmentImg";
  ...
  return (
    <>
      <div className="mx-3 position-relative ">
                    ...
                    <Col lg="3" md="4" className="shadow-lg">
                      <div className="single__free__course p-3">
                        ...
                        <div className="free__course__details">
                          ...
                          <div className=" d-flex align-items-center gap-5 justify-content-between mx-3"></div>
                        </div>
                      </div>
                    </Col>
                  );
        ...
        <div className="my-3 Assignment-pro ms-3 ">
          <h2>Assignment</h2>
        </div>
        <div>
          <AssignmentImg />
